...
let parsed: {
  ...
  COVERBOT_SUPPORT_MODE: false,
  COVERBOT_CHAIN_PROVIDER: 'https://dai.poa.network',
  COVERBOT_DEBUG_HOPR_ADDRESS: '',
  COVERBOT_TIMESTAMP: undefined,
  COVERBOT_RESTORE_SCORE_FROM: undefined
}
...
export const COVERBOT_DEBUG_MODE = JSON.parse(`${parsed.COVERBOT_DEBUG_MODE}`) // Stuff like this...
export const COVERBOT_SUPPORT_MODE = JSON.parse(`${parsed.COVERBOT_SUPPORT_MODE}`)
...
export const COVERBOT_TIMESTAMP = parsed.COVERBOT_TIMESTAMP
export const COVERBOT_RESTORE_SCORE_FROM = parsed.COVERBOT_RESTORE_SCORE_FROM
